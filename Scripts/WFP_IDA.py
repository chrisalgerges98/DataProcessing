...
#
# fOut = open("SenegalUgandaAverageChart.html", "a")
# f = figure(plot_width=750, plot_height=350, title="average price of grain products per country")
# legend_it = []
# for country, color in zip(countries, my_palette):
#     source = ColumnDataSource(name = "data", data=dict(
#         average_price = df_3["average_price"][df_3["country"] == country],
...
# f.legend.visible=False
# f.add_layout(legend, "right")
# html = file_html(f, CDN, "SenegalUgandaAverageChart")
# fOut.write(html)
# fOut.close()
